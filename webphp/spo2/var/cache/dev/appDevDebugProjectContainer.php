...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'spo2_dev', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/AccountBundle/Entity'), 1 => ($this->targetDirs[3].'/src/GraphBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'AccountBundle\\Entity');
        $c->addDriver($b, 'GraphBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('AccountBundle' => 'AccountBundle\\Entity', 'GraphBundle' => 'GraphBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_c8911928eb1d86119d4d2e3ace94787b301e33af44b6135306e452661fa83ae5');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/GraphBundle/Resources/views'), 'Graph');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('386fc86db1ad9260f1ab051055b1daf8b04b032e');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56cc82d81e6fa6.14577299')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'GraphBundle' => 'GraphBundle\\GraphBundle',
            ...
            'secret' => '386fc86db1ad9260f1ab051055b1daf8b04b032e',
            'locale' => 'en',
            'database_host_dev' => 'localhost',
            'database_port_dev' => NULL,
            'database_name_dev' => 'spo2_dev',
            'database_user_dev' => 'root',
            'database_password_dev' => 'root',
            'mailer_transport_dev' => 'smtp',
            'mailer_host_dev' => '127.0.0.1',
            'mailer_user_dev' => NULL,
            'mailer_password_dev' => NULL,
            'secret_dev' => '386fc86db1ad9260f1ab051055b1daf8b04b032e',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '386fc86db1ad9260f1ab051055b1daf8b04b032e',
