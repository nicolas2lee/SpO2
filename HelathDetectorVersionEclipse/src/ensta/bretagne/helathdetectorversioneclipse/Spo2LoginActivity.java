 ...
 * */
public class Spo2LoginActivity extends Activity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spo2_login);
        ...
        try{
            ...
            if (!f.exists()){
                f.mkdirs();
                f.createNewFile();
               // CopyDB(getBaseContext().getAssets().open("mytesteddb"),
                //    new FileOutputStream(destPath+"/MyDB.sql"));
            }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.activity_spo2_login, menu);
        return true;
    }
